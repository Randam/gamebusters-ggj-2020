...
export class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.titleText = this.add.text(this.sys.canvas.width / 2, this.sys.canvas.height / 4, 'Wandering Wanker', {
            fontFamily: 'Perpetua',
            fontSize: 120,
            color: '#dddddd',
            boundsAlignH: "center",
        ...
        this.startText = this.add.text(this.sys.canvas.width / 2, this.sys.canvas.height / 1.5, 'Start', {
